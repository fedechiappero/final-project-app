...
class DestinoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $destinos = $em->getRepository('AppBundle:Destino')->findAll();
    ...
    {
        $destino = new Destino();
        $form = $this->createForm('AppBundle\Form\DestinoType', $destino);
    ...
    {
        $deleteForm = $this->createDeleteForm($destino);
        $editForm = $this->createForm('AppBundle\Form\DestinoType', $destino);
